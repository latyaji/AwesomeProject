...
export const BankAccountdetails = ({navigation, route}) => {
  ...
  const [passbooksumbiteddata, setPassbooksumbiteddata] = useState(
    routes?.pansumbiteddata,
  ); // Initialize with the submittedData
  ...
  const handlePassbookSubmit = () => {
    ...
    navigation.navigate('Address', {
      passbooksumbiteddata: [...passbooksumbiteddata, passbookuploaddata],
    });
  };
      ...
      <KeyboardAvoidingView behavior="padding">
        <ScrollView>
          ...
          {passbookuploaddata.panfileResponse.map((file, index) =>
            passbookuploaddata.panfileResponse ? (
