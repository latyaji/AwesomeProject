...
//   console.log("lasttttttttt$$$$$$$,",routes)
...
//   // const [sumbiteddata, setsumbiteddata] = useState(routes?.passbookuploaddata || {}); // Initialize with the submittedData
//   const [sumbiteddata, setsumbiteddata] = useState(routes?.passbookuploaddata || []); // Initialize with the submittedData
...
//       setAddressuploaddata({ ...addressuploaddata, panfileResponse: response })
...
//   console.log("sumbiteddata finalllyyyy",sumbiteddata)
...
//  console.log("888888",sumbiteddata)
  ...
  const handleSubmit = () => {
    ...
    if (!addressuploaddata.battertwo) { // Add the validation check for the "Battery 2" field
      setValidationErrors((prevState) => ({ ...prevState, batteryTwo: 'Please enter Battery 2' }));
      return;
    }
    if (!addressuploaddata.remark) { // Add the validation check for the "Remark" field
  ...
  // console.log("last mai submit data",sumbiteddata)
